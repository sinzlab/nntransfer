mkdir -p /work/data/image_classification
...
mkdir -p val/images
tar xfv ILSVRC2012_img_val.tar -C val/images && rm ILSVRC2012_img_val.tar
cd val/images
...
cd ../../
mkdir train
tar xfv ILSVRC2012_img_train.tar -C train && rm ILSVRC2012_img_train.tar
cd train
